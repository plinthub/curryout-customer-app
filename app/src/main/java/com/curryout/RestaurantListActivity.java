...
public class RestaurantListActivity extends AppCompatActivity {
    ...
    TextView txtViewDetailResturant,txt_SearchRes,txtViewItRes,txtViewDetailRes;
    public RestaurantListActivity() {

    }
//    public RestaurantListActivity(String cid) {
//        this.cid = cid;
//        Log.e("Cusine_Id",cid);
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RelativeLayout rl_toolbar = (RelativeLayout) findViewById(R.id.rl_toolbar);
        alist = new ArrayList<>();
    ...
    private void init() {
        ...
        linearViewCartResturant = findViewById(R.id.linearViewCartResturant);
//        txtViewDetailResturant = findViewById(R.id.txtViewDetailResturant);
        linearViewCartResturant.setVisibility(View.GONE);
        callgetCartItemList();
        txt_SearchRes = findViewById(R.id.txt_SearchRes);
        txtViewItRes = findViewById(R.id.txtViewItRes);
        txtViewDetailRes = findViewById(R.id.txtViewDetailRes);

    }
    private void listener() {
        txt_SearchRes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(RestaurantListActivity.this,SearchActivity.class);
                startActivity(in);
            }
        });
    }
...
//        handler.removeCallbacks(runnable);
    ...
    public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final RestaurantListAdapter.ViewHolder holder, int position) {
            ...
            Glide.with(RestaurantListActivity.this).load(Uri.parse(restauListData.getImgRestauran()))
...
//                    activity.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, myFragment).addToBackStack(null).commit();
                    ...
                    Intent in = new Intent(RestaurantListActivity.this, SingleItemRestuActivity.class);
                    in.putExtra("RID",rid);
                    startActivity(in);
    ...
    public void callGetAllRestaurants() {
        if (!CommonUtilities.isOnline(RestaurantListActivity.this)) {
            Toast.makeText(RestaurantListActivity.this, R.string.no_internet_connection, Toast.LENGTH_SHORT).show();
            return;
        }

//        final ProgressDialog pd = new ProgressDialog(RestaurantListActivity.this);
//        pd.setTitle("Please Wait");
//        pd.setCancelable(false);
//        pd.show();

        final CustomProgressDialogue pd= new CustomProgressDialogue(RestaurantListActivity.this);
        pd.setCancelable(false);
        pd.show();
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                header.put("X-Auth-Token", AppSharedPreference.loadTokenPreference(RestaurantListActivity.this));
                return header;
            }
        ...
        VolleySingleton.getInstance(RestaurantListActivity.this).addToRequestQueue(sr);
    }

    public void parseResponse(String response) {
        Log.e("COut Cuisi_ID Response", "response " + response);
        try {
            ...
            if (data == true) {
                ...
                for (int i = 0; i < jarr.length(); i++) {
                    ...
                    Log.e("RD2", food_type);
                    Log.e("RD3", url);
                    restaurantDataModel = new RestaurantDataModel(restrauntID,name, url, address,image);
    ...
    public void parseResponseItemList(String response) {
        ...
        try {
            ...
            if(cartarr.length()==0){
                ...
                txtViewItRes.setText(cartarr.length()+"");
                linearViewCartResturant.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent in = new Intent(RestaurantListActivity.this,CartActivity.class);
                        startActivity(in);
                    }
                });
            }
...
//                Log.e("AddItemPrice", addonitemprice);
            ...
            if (data == false) {
                ...
                if (message.equalsIgnoreCase("The Product Id field is required.<br>\n")) {
                    Toast.makeText(RestaurantListActivity.this, "Product Id Cannot Be Blank", Toast.LENGTH_SHORT).show();
                }
            }
